...
client.on('ready', () => {
  ...
  console.log('---------------')
    client.user.setGame(` ${prefix}help | ${prefix}invite   `, "http://twitch.tv/Streammingg")
...
client.on('message', message => {
  if(message.content.startsWith(prefix + "sar7")) {
...
client.channels.get("480143891060752386").send(`:white_check_mark: **${client.user.tag} دخل سيرفر جديد
...
Server Count: __${guild.memberCount}__**`)
   ...
   client.on('guildCreate', guild => {
client.channels.get("480143920077078528").send(`:white_check_mark: **${client.user.tag} دخل سيرفر جديد
Server name: __${guild.name}__
Server owner: __${guild.owner}__
Server id: __${guild.id}__ 
Server Count: __${guild.memberCount}__**`)
...
client.on('guildDelete', guild => {
  client.channels.get("480143920077078528").send(`:negative_squared_cross_mark: **${client.user.tag} طلع من سيرفر
Server name: __${guild.name}__
Server owner: __${guild.owner}__
Server id: __${guild.id}__ 
Server Count: __${guild.memberCount}__**`)
...
message.author.send(`**Done..**`).catch(RebeL =>{console.log('`Error`: ' + RebeL);
...
//ReBeL & Codes
  ...
  if(message.content.startsWith(prefix + "bcall")) {
    ...
    if(message.author.id !== '470500980342128650') return message.channel.send('❎ » هذا الأمر مخصص لصاحب البوت فقط');
    var args = message.content.split(' ').slice(1).join(' ');
